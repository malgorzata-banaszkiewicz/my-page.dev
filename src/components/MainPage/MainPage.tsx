	...
	return (
		<>
			<div>
				<h1>Page contents 🚀</h1>
				<span>
					Page about Małgorzata Banaszkiewicz. Junior Front-end Developer.
					Nature lover. Active person. Dreaming about travelling.
				</span>
			</div>
			...
			<Image
				src={Bike}
				alt='woman on a bike with a doggy'></Image>
		</>
	);
};
